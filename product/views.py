...
def products_view(request):
    ...
    products = Product.objects.all().prefetch_related(Prefetch('variants', queryset=ProductVariant.objects.filter(is_deleted=False)),'images')
    ...
    # print("this data is passed to html",data)
